...
namespace LearnPHPMVC {
    ...
    class Router extends Base {
        ...
        */
        ...
        public function removeRoute($routeToRemove) {
            if ( ( $stored = array_search($routeToRemove, $this->_routes) ) !== false ) {
                unset( $this->_routes[$stored] );
            }
            return $this;
        }
        ...
        protected function _pass($controller, $action, $parameters = array()) {
            $name = ucfirst( strtolower( $controller) );
